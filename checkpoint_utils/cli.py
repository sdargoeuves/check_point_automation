#!/usr/bin/env python3
"""
CheckPoint Automation CLI Tool
Command-line interface for CheckPoint firewall management tasks.
"""
...
Examples:
  ...
  # Run specific tasks
  cp_automate 10.194.59.200 --task 1
  cp_automate 10.194.59.200 -t 2,3
  
  # Custom credentials and timeouts
  cp_automate 10.194.59.200 -u admin -p mypass -e myexpert --task 1,2
  cp_automate 10.194.59.200 --timeout 60 --read-timeout 10 --task 2
  
  # Debug with extended timeouts
  cp_automate 10.194.59.200 --log-level debug --timeout 120 --task 1
        """,
    )
...
def run_tasks(config: FirewallConfig, task_list: List[int]) -> bool:
    """

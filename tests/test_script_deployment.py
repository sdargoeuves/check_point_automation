#!/usr/bin/env python3
"""
Test script deployment functionality.
"""
...
def test_script_deployment():
    """Test script deployment and execution functionality."""
    
    # Configuration - update with your firewall details
...
# At this point, the Firewall is expected to reboot.
# The SSH connection will be terminated.
echo "===================================================="
echo "Configuration applied. Firewall is expected to reboot now, SSH connection will be lost."
echo ""

"""
    
    print(f"Testing script deployment to {config.ip_address}")
    ...
    try:
        ...
        with SSHConnectionManager(config, console_log_level="DEBUG") as ssh_manager:
            ...
            # Deploy and execute the test script
            print("Deploying and executing test script...")
            success, output = script_manager.deploy_and_execute_script(test_script_content)
...
if __name__ == "__main__":
    success = test_script_deployment()

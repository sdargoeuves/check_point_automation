...
from checkpoint_automation.core.models import (
    CheckPointState, CLIMode, NetworkObjectType, FirewallAction,
    InterfaceConfig, OSPFArea, OSPFNetwork, OSPFConfig, LLDPConfig,
    NetworkObject, FirewallRule, WizardConfig, CheckPointConfig,
    SystemStatus, CommandResult, ConnectionInfo
)
...
class TestSystemStatus:
    ...
    def test_system_status_validation(self):
        ...
        with pytest.raises(ValueError, match="Version cannot be empty"):
            SystemStatus(
                state=CheckPointState.FRESH_INSTALL,
                version="",
                hostname="test"
            )
